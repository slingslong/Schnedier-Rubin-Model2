...
to run-contest
  ...
  set player1 one-of turtles with [group = 1]
  set player2 one-of turtles with [group = 0]
...
@#$#@#$#@
<experiments>
  <experiment name="Attribution Contest" repetitions="5" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>winner = turtle num1</metric>
    ...
    <enumeratedValueSet variable="age-of-scientist">
      <value value="0"/>
      <value value="50"/>
      <value value="99"/>
    </enumeratedValueSet>
    <steppedValueSet variable="random-seed" first="100" step="25" last="201"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
